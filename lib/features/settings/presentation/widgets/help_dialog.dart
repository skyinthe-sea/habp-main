        ...
        children: [
          ...
          _buildStepCard(
            ...
            content: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                Text('1. 자산 화면에서 우측 하단의 설정 버튼을 탭합니다.'),
                Text('2. 자산 유형을 선택합니다. (부동산, 예금, 주식 등)'),
                Text('3. 자산 이름과 현재 가치를 입력합니다.'),
                Text('4. 필요에 따라 구매 가치, 구매 날짜, 이자율 등의 추가 정보를 입력합니다.'),
                Text('5. 저장 버튼을 눌러 자산을 추가합니다.'),
              ],
            ),
          ),
          _buildStepCard(
            ...
            content: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                Text('1. 자산 목록에서 수정/삭제할 자산을 탭합니다.'),
                Text('2. 상세 화면에서 수정하기 버튼을 눌러 정보를 업데이트하거나, 삭제하기 버튼을 눌러 자산을 삭제합니다.'),
                Text('3. 자산 가치가 변경되면 현재 가치를 업데이트하여 수익률을 확인할 수 있습니다.'),
              ],
            ),
          ),
          _buildStepCard(
            ...
            content: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                Text('1. 자산 화면 상단의 요약 카드에서 총 자산 가치와 자산별 비율을 확인할 수 있습니다.'),
                Text('2. 각 자산을 탭하면 해당 자산의 상세 정보와 증감률을 확인할 수 있습니다.'),
                Text('3. 자산 유형별 필터를 사용하여 원하는 자산만 볼 수 있습니다.'),
              ],
            ),
          ),
        ],
        ...
        children: [
          ...
          _buildStepCard(
            ...
            content: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                Text('1. 예산 화면에서 우측 하단의 설정 버튼을 탭합니다.'),
                Text('2. 카테고리를 선택하고 예산 금액을 입력합니다.'),
                Text('3. 새 카테고리가 필요하면 "카테고리 추가" 버튼을 눌러 만들 수 있습니다.'),
                Text('4. 저장 버튼을 눌러 예산을 설정합니다.'),
              ],
            ),
          ),
          _buildStepCard(
            ...
            content: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                Text('1. 상단의 월 선택기를 사용하여 원하는 월의 예산을 확인할 수 있습니다.'),
                Text('2. 전체 예산 진행 상황은 상단 카드에서 확인할 수 있습니다.'),
                Text('3. 카테고리별 예산 진행 상황은 목록에서 확인할 수 있습니다.'),
                Text('4. 예산을 초과한 카테고리는 빨간색으로 표시됩니다.'),
              ],
            ),
          ),
          _buildStepCard(
            ...
            content: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                Text('1. 카테고리를 탭하면 해당 카테고리의 세부 분석을 볼 수 있습니다.'),
                Text('2. 요일별, 일별 지출 패턴을 확인할 수 있습니다.'),
                Text('3. 지난달 대비 변화를 확인하고 지출 패턴을 분석할 수 있습니다.'),
                Text('4. 지출 내역 탭에서 해당 카테고리의 모든 거래를 확인할 수 있습니다.'),
              ],
            ),
          ),
          _buildStepCard(
            ...
            content: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                Text('1. 새 달이 시작되면 자동으로 이전 달의 예산을 복사할지 물어봅니다.'),
                Text('2. 또는 예산 설정 화면에서 이전 달 예산을 복사할 수 있습니다.'),
                Text('3. 필요에 따라 각 카테고리의 예산을 조정할 수 있습니다.'),
              ],
            ),
          ),
        ],
