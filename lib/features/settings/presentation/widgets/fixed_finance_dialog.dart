...
class _FixedFinanceDialogState extends State<FixedFinanceDialog> with SingleTickerProviderStateMixin {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            _isDetailViewMode
                                ? (_selectedCategory?.name ?? '고정 재테크 상세')
                                : '고정 재테크 관리',
                ...
                // Finance stats summary - Only show when not in detail view
  ...
  // List of fixed finance categories
  ...
  // Confirm deletion of fixed finance
  void _confirmDelete() async {
    ...
    try {
      ...
      Get.snackbar(
        '삭제 완료',
        '${_deleteFromDate.toString().substring(0, 10)} 이후의 ${_selectedCategory!.name} 고정 재테크가 삭제되었습니다.',
        backgroundColor: Colors.green[100],
        borderRadius: 12,
        margin: const EdgeInsets.all(12),
        snackPosition: SnackPosition.BOTTOM,
